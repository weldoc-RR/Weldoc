...
export default async function ChartePage() {
  ...
  return (
    <main style={{ fontFamily: "sans-serif", padding: "2rem" }}>
      ...
      <h1>Weldoc — Charte d&apos;utilisation et d&apos;intégrité</h1>
      <p>
      ...
      {!charteEnVigueur ? (
        ...
        <div style={{ border: "1px solid #ddd", padding: "1rem", maxWidth: 700 }}>
          ...
          {jeLaiAcceptee ? (
            <p style={{ color: "#0ca30c" }}>✓ Vous avez accepté cette version.</p>
          ) : (
